...
return [
    ...
    */
    ...
    'confirmed'            => 'Potwierdzenie pola <b>:attribute</b> nie zgadza się.',
    ...
    'unique'               => ':attribute już występuje w naszej bazie danych.',
    ...
    */
    ...
    'custom' => [
        'username'  => [
            'required'  => 'Nie wprowadzono nazwy użytkownika.',
            'unique'    => 'Wprowadzona nazwa użytkownika jest już zajęta.',
            'max'       => 'Nazwa użytkownika może zawierać maksymalnie :max znaków.'
        ],
        'email' => [
            'required'  => 'Nie wprowadzono adresu e-mail.',
            'email'     => 'Wprowadzono nieprawidłowy adres e-mail.',
            'max'       => 'Adres e-mail może zawierać maksymalnie :max znaków.',
            'unique'    => 'Ten adres e-mail jest już powiązany z innym użytkownikiem.'
        ],
        'first_name' => [
            'required'  => 'Musisz podać swoje imię.',
            'max'       => 'Imię nie może być dłuższe niż :max liter.',
            'min'       => 'Imię musi mieć co najmniej :min litery.'
        ],
        'last_name' => [
            'max'       => 'Nazwisko nie może być dłuższe niż :max liter.',
            'min'       => 'Nazwisko musi mieć co najmniej :min litery.'
        ],
        'old_password'  => [
            'required'  => 'Nie wprowadzono aktualnego hasła.',
        ],
        'password'  => [
            'required'  => 'Nie wprowadzono hasła.',
            'min'       => 'Hasło musi mieć co najmniej :min znaków.',
            'confirmed' => 'Wprowadzone hasła różnią się od siebie.'
        ],
        'password_confirmation'  => [
            'required'  => 'Musisz potwierdzić wprowadzone hasło.',
        ],
        'birth_date' => [
            'required'  => 'Musisz podać datę urodzenia.',
            'date'      => 'Wprowadzono nieprawidłową datę urodzenia.'
        ],
        'gender' => [
            'required'  => 'Musisz wybrać swoją płeć.',
            'in'        => 'Musisz wybrać jedną opcję.'
        ],
        'country' => [
            'required'  => 'Musisz wybrać kraj.',
            'numeric'   => 'W tym polu mogą znajdować się tylko liczby.'
        ],
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'twitter_url'   => 'Nazwa użytkownika (Twitter)',
        'instagram_url' => 'Nazwa użytkownika (Instagram)',
        'twitch_url'    => 'Nazwa użytkownika (Twitch)',
        'website_url'   => 'Strona internetowa',
    ],
];
