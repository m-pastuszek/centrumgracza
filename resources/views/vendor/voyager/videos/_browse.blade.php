                                ...
                                @foreach($dataTypeContent as $data)
                                    <tr>
                                        ...
                                        <td class="no-sort no-click" id="bread-actions">
                                            ...
                                            @endcan
                                            @can('read', $data)
                                                <a href="/film/{{  $data->slug }}" title="{{ __('voyager::generic.view') }}" class="btn btn-sm btn-warning pull-right">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"><i class="voyager-trash"></i> Czy na pewno chcesz usunąć ten film?</h4>
                </div>
