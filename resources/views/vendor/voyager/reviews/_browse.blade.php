...
@section('page_title') {{ $dataType->display_name_plural }} @endsection
    ...
    <div class="container-fluid">
        ...
        @can('add', app($dataType->model_name))
            <a href="{{ route('voyager.'.$dataType->slug.'.create') }}" class="btn btn-success btn-add-new">
                <i class="voyager-plus"></i> <span> Dodaj recenzję</span>
            </a>
        @endcan
                                ...
                                @foreach($dataTypeContent as $data)
                                    <tr>
                                        ...
                                        <td class="no-sort no-click" id="bread-actions">
                                            ...
                                            @endcan
                                            @can('read', $data)
                                                <a href="/recenzja/{{  $data->slug }}" title="{{ __('voyager::generic.view') }}" class="btn btn-sm btn-warning pull-right">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"><i class="voyager-trash"></i> Czy na pewno chcesz usunąć tą recenzję?</h4>
                </div>
