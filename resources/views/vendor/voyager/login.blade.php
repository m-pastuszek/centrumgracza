    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-5 col-md-4 login-sidebar">
            ...
            <div class="login-container">
                ...
                <p style="font-size: 13px">{{ __('voyager::login.signin_below') }}</p>
                ...
                <form action="{{ route('voyager.login') }}" method="POST">
                    ...
                    <div class="form-group form-group-default" id="passwordGroup">
                        ...
                        <small id="emailHelp" class="form-text text-muted"><a href="{{ route('password.request') }}">Nie pamiętasz hasła? Kliknij tutaj!</a></small>
                    </div>
